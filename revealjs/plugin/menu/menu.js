	...
	function loadPlugin() {
		...
		if (!head.browser.ie || head.browser.version >= 9) {
			...
			if (typeof themes === "undefined") {
				themes = [
					{ name: 'Black', theme: '/reveal/revealjs/css/theme/black.css' },
					{ name: 'White', theme: '/reveal/revealjs/css/theme/white.css' },
					{ name: 'League', theme: '/reveal/revealjs/css/theme/league.css' },
					{ name: 'Sky', theme: '/reveal/revealjs/css/theme/sky.css' },
					{ name: 'Beige', theme: '/reveal/revealjs/css/theme/beige.css' },
					{ name: 'Simple', theme: '/reveal/revealjs/css/theme/simple.css' },
					{ name: 'Serif', theme: '/reveal/revealjs/css/theme/serif.css' },
					{ name: 'Blood', theme: '/reveal/revealjs/css/theme/blood.css' },
					{ name: 'Night', theme: '/reveal/revealjs/css/theme/night.css' },
					{ name: 'Moon', theme: '/reveal/revealjs/css/theme/moon.css' },
					{ name: 'Solarized', theme: '/reveal/revealjs/css/theme/solarized.css' }
				];
			}
